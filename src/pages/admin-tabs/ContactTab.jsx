...
const LOGOS = [
  ...
  { key: 'pwaLogo',   label: 'לוגו לאפליקציה',     hint: 'האייקון כשמוסיפים את האתר הראשי למסך הבית. ריק → לוגו אוטומטי מהאותיות והצבעים' },
  { key: 'adminLogo', label: 'לוגו אדמין לאפליקציה', hint: 'האייקון כשמוסיפים את אתר הניהול למסך הבית, ומוצג גם בראש פאנל הניהול' },
];
